                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="fw-bold mb-0">Nouvelle Ordonnance</h3>
                            <a href="consultation.php" class="btn btn-primary">Ordonnace précédente</a>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                <div class="row mb-3">
                            ...
                            <div class="card-body">
                                <form method="GET">
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            <label for="patient" class="form-label">Nom et Prénom(s)</label>
                                            <select name="patient" id="patient" class="form-control">
                                                <option value="Jean">Jean Pierre</option>
                                            </select>
                                        </div>
                                        <div class=" py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                            <h6 class="mb-0 fw-bold ">Inforamtion sur la prescription</h6>
                                        </div>
                                        <div class="col-md-12">
...
<script>
    ...
    placeholder: 'Veuillez lister les presciptions pour le patient',
    tabsize: 2,
    height: 100
    });
</script>
