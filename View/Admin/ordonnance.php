            ...
            <div class="container-xxl">
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="fw-bold mb-0">Ordonnaces</h3>
                            <a href="newOrdonnance.php" class="btn btn-primary">Générer un nouvelle</a>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                <div class="row mb-3 align-center">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">ORDONNANCE N°45851</h5>
                            <p class="card-text"><strong>Jean Pierre</strong></p>
                            <a href="impressionOrdonnance.php" class="btn btn-primary text-center">Télécharger</a>
                        </div>
                    </div>
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="../assets/images/gallery/1.jpg" alt="" />
