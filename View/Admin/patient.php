                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="fw-bold mb-0">Liste des Patients</h3> <a href="newPatient.php" class="btn btn-primary">Ajouter nouveau Patient</a>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                <div class="row mb-3">
                            ...
                            <table id="patient-table" class="table table-hover align-middle mb-0" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Cotonou, Bj</td>
                                        <td class="text-center"><a href="newConsultation.php?patient=Jean" class="btn btn-warning mx-2">Aller en consultation</a></td>
                                    </tr>
                                    <tr>
                                        <td>PT-0001</td>
                                        <td><img src="../assets/images/xs/avatar3.jpg" class="avatar  rounded-circle me-2" alt="profile-image"><span>Jean Pierre </span></td>
