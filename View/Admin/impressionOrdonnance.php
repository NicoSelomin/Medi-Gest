      ...
      <div class="col-md-8 offset-md-2">
        <div class="card">
          <div class="card-header bg-primary text-white">
            <h3 class="card-title text-center">Ordonnance de Prescription</h3>
          </div>
          <div class="card-body">
            ...
            <div class="mb-3">
              <h4 class="mx-4">Nom et Prénom du patient : Jon baclimi</h4>  
            </div>
            ...
            <div class="mb-3 mx-4">
              <ol>
                <li>
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam aut cupiditate minima consequuntur earum accusantium.</p>  
                </li>
          ...
          <div class="card-footer text-muted">
            <button type="button" class="btn btn-primary text-white">Imprimer l'Ordonnance</button>
          </div>
        </div>
      </div>
    </div>
