                            ...
                            <div class="card-body">
                                <div class="row g-3 row-deck">
                                    <div class="col-md-4 col-sm-6">
                                        <div class="card">
                                            <div class="card-body ">
                                                ...
                                                <h6 class="mt-3 mb-0 fw-bold small-14">Total Consultations</h6>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="card">
                                            <div class="card-body ">
                                                ...
                                                <h6 class="mt-3 mb-0 fw-bold small-14">Total Docteurs</h6>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="card">
                                            <div class="card-body ">
                                                <i class="icofont-patient-bed fs-3 color-light-success"></i>
                                                <h6 class="mt-3 mb-0 fw-bold small-14">Total Dossiers Patients </h6>
