...
<!-- Mirrored from pixelwibes.com/template/ihealth/html/dist/ui-elements/auth-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 May 2024 19:56:47 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row g-0">
                    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
                        <div style="max-width: 25rem;">
                            ...
                            <div class="mb-5">
                                <h2 class="color-900 text-center">I-Health, Inscription</h2>
                            </div>
                            <!-- Image block -->
                            <div class="">
                        ...
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            ...
                            <form class="row g-1 p-3 p-md-4">
                                <div class="col-12 text-center mb-5">
                                    ...
                                    <span>Avec notre application de santé, la vie est plus simple</span>
                                </div>
                                <div class="col-6">
                                    <div class="mb-2">
                                ...
                                <div class="col-6">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" placeholder="Votre adresse">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-2">
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault">
                                            J'accepte <a href="#" title="Terms and Conditions">les termes et conditions</a>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12 text-center mt-4">
                                    <a href="User/index.php" class="btn btn-lg btn-block btn-light lift text-uppercase" alt="SIGNUP">Je m'inscris</a>
                                </div>
                                
                                <div class="col-12 text-center mt-4">
                                    <span>Avez-vous déjà un compte ? <a href="connexion.php" title="Sign in" >Connexion</a></span>
                                </div>
                            </form>
                            <!-- End Form -->
